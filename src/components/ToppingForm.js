        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="toppings"
              onChange={ props.toppings.includes('Mild Hot Sauce') }
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="toppings"
              onChange={ props.toppings.includes('Medium Hot Sauce') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="HOT Hot Sauce"
              name="toppings"
              onChange={ props.toppings.includes('HOT Hot Sauce') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Corn Salsa"
              name="toppings"
              onChange={ props.toppings.includes('Corn Salsa') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Sour Cream"
              name="toppings"
              onChange={ props.toppings.includes('Sour Cream') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Lettuce"
              name="toppings"
              onChange={ props.toppings.includes('Lettuce') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Guac"
              name="toppings"
              onChange={ props.toppings.includes('Guac') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Cheese"
              name="toppings"
              onChange={ props.toppings.includes('Cheese') }
              onChange={ props.handleChange }
            />
