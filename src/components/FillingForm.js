          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="White Rice"
                name="fillings"
                onChange={ this.props.fillings.includes('White Rice') }
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Brown Rice"
                name="fillings"
                onChange={ this.props.fillings.includes('Brown Rice') }
                onChange={ this.props.handleChange }
              />
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Black Beans"
                name="fillings"
                onChange={ this.props.fillings.includes('Black Beans') }
                onChange={ this.props.handleChange }
              />
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Pinto Beans"
                name="fillings"
                onChange={ this.props.fillings.includes('Pinto Beans') }
                onChange={ this.props.handleChange }
              />
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                name="fillings"
                onChange={ this.props.fillings.includes('Fajita Veggies') }
                onChange={ this.props.handleChange }
              />
