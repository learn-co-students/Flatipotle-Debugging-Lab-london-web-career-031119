          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Barbacoa"
                name="protein"
                onChange={ this.props.protein.includes('Barbacoa') }
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Steak"
                name="protein"
                onChange={ this.props.protein.includes('Steak') }
                onChange={ this.props.handleChange }
              />
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Chicken"
                name="protein"
                onChange={ this.props.protein.includes('Chicken') }
                onChange={ this.props.handleChange }
              />
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Carnitas"
                name="protein"
                onChange={ this.props.protein.includes('Carnitas') }
                onChange={ this.props.handleChange }
              />
          ...
          <div className="field">
            <div className="ui checkbox">
              <input
                ...
                value="Sofritas"
                name="protein"
                onChange={ this.props.protein.includes('Sofritas') }
                onChange={ this.props.handleChange }
              />
