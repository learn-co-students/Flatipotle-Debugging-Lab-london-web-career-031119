        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips"
              name="sides"
              onChange={ props.sides.includes('Chips') }
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Salsa"
              name="sides"
              onChange={ props.sides.includes('Chips & Salsa') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Guac"
              name="sides"
              onChange={ props.sides.includes('Chips & Guac') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Queso"
              name="sides"
              onChange={ props.sides.includes('Chips & Queso') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Tortilla"
              name="sides"
              onChange={ props.sides.includes('Tortilla') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Taco"
              name="sides"
              onChange={ props.sides.includes('Taco') }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="sides"
              onChange={ props.sides.includes('Fountain Drink') }
              onChange={ props.handleChange }
            />
